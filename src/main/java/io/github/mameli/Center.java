...
/**
 * Created by mameli on 18/02/2017. Center of k means
 */
public class Center extends Point {
  ...
  void divideCoordinates() {
    for (int i = 0; i < this.getListOfCoordinates().size(); i++) {
      this.getListOfCoordinates().set(i,
          new DoubleWritable(this.getListOfCoordinates().get(i).get() / numberOfPoints.get()));
    }
  }
